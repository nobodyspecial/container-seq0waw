...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-seq0waw.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-seq0waw.containers.anotherwebservice.com/
...
```
git clone git@github.com:nobodyspecial/container-seq0waw.git
cd container-seq0waw
```
...
```
docker attach container-seq0waw
```
